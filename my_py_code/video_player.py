...
class VideoPlayer(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        uic.loadUi('./gui/video_player.ui', self)
    ...
    def load_widgets_find(self):
        ...
        self.stop_video = self.findChild(QtWidgets.QPushButton, 'stop_video')
        self.add_video_file = self.findChild(QtWidgets.QPushButton, 'add_video_file')
    ...
    def load_clicked(self):
        # video player
        self.add_video_file.clicked.connect(self.video_file)
        self.play_video.clicked.connect(self.played_video)
        self.stop_video.clicked.connect(self.main_video_player.handleQuit)
        ...
        # self.video_proses.readyRead.connect(self.dataReady)
        # self.video_proses.finished.connect(self.playFromURL)
    ...
    def video_file(self):
        self.main_video_player.openFile()
